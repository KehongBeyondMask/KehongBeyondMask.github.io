...
2. Zhang Guo*, **Kehong Liu***, Hantao Zhao, Nuo Tong, Shuiping Gou, Wenbo Liu, Qigong Sun, and Licheng Jiao, "[Physiological Information-Guided Network for Heart Rate Estimation from Near-Infrared Facial Video](../assets/TIM.pdf)," **IEEE Transactions on Industrial Informatics** (JCR Q1, IF=9.9), **(\* means co-first author and equal contributions, Zhang Guo is my supervisor, This paper is completed on my own🤫)**. [[pdf](../files/TII.pdf)]
